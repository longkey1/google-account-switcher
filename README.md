...
## Development & Build
A GitHub Actions workflow is included to automatically package the extension into a ZIP file whenever you push to the `main` branch. The packaged extension can be found in the "Actions" tab as an Artifact.
